...
public class OSLab11 {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setTitle("操作系统实验1（先来先服务、优先级优先、时间片轮转）（制作者:黄钰竣 3117004568）");
		...
		JRadioButton radioButton = new JRadioButton("\u5148\u6765\u5148\u670D\u52A1");
		...
		radioButton.setBounds(184, 40, 103, 27);
		panel.add(radioButton);

		JRadioButton radioButton_1 = new JRadioButton("\u4F18\u5148\u7EA7\u4F18\u5148");
		radioButton_1.setBounds(316, 40, 103, 27);
		...
		JRadioButton radioButton_2 = new JRadioButton("\u65F6\u95F4\u7247\u8F6E\u8F6C");
		radioButton_2.setBounds(184, 81, 103, 27);
		radioButton_2.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				mode = SLICE_ROTATION;
				System.out.println("你选择了时间片轮转调度算法！");
			}
		});
		...
		button_1.setBounds(486, 10, 92, 27);
		...
		button_3.setBounds(486, 54, 92, 27);
